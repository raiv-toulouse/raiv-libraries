...
for number_file in range(2, 8): # Numéro du fichier

    road = '/common/data_courbes_matplotlib/RGB/150im/train/data_model_TRAIN' + str(number_file) + '.txt'
    a_file = open(road, "r")
