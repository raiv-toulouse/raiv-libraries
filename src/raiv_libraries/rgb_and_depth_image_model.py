...
class RgbAndDepthImageModel:
    def __init__(self,
                 ...
                 fine_tuning=True):
        super(RgbAndDepthImageModel, self).__init__()
        # Parameters
...
#       # if self.fine_tuning:  PJ Generate bugs (see https://github.com/PyTorchLightning/pytorch-lightning/discussions/7092)
